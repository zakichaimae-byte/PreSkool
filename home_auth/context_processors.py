def translations(request):
    ...
    translations_dict = {
        'fr': {
            ...
            'my_quizzes': 'Mes Quiz',
            'digital_logbook': 'Cahier de Texte',
            'take_quiz': 'Passer un Quiz',
            'add_session': 'Ajouter une Séance',
            'my_appointments': 'Mes Rendez-vous',
            'manage_availability': 'Mes Disponibilités',
            'book_appointment': 'Prendre RDV',
            'homework_hub': 'Hub de Devoirs',
            'my_performance': 'Ma Performance',
            'my_loans': 'Mes Emprunts',
            'manage_loans': 'Gérer les Emprunts',
        },
        'en': {
            ...
            'manage_availability': 'My Availability',
            'book_appointment': 'Book Appointment',
            'homework_hub': 'Homework Hub',
            'my_performance': 'My Performance',
            'my_loans': 'My Borrowings',
            'manage_loans': 'Manage Borrowings',
        },
        'ar': {
            ...
            'digital_logbook': 'دفتر النصوص الرقمي',
            'take_quiz': 'إجراء اختبار',
            'add_session': 'إضافة حصة',
            'my_appointments': 'مواعيدي',
            'manage_availability': 'توفري',
            'book_appointment': 'حجز موعد',
            'homework_hub': 'مركز الواجبات',
            'my_performance': 'أدائي الدراسي',
            'my_loans': 'كتبي المستعارة',
            'manage_loans': 'إدارة الاستعارة',
        }
    }
